...
t.add("This is not a valid IP address.", "D\u00ebse W\u00e4ert ass keng g\u00fclteg IP-Adress.", "validators", "lb");
...
t.add("This is not a valid International Bank Account Number (IBAN).", "D\u00ebse W\u00e4ert ass keng g\u00fclteg International Bankkontonummer (IBAN).", "validators", "lb");
...
t.add("This is not a valid Business Identifier Code (BIC).", "D\u00ebse W\u00e4ert ass kee g\u00fcltege Business Identifier Code (BIC).", "validators", "lb");
t.add("Error", "Feeler", "validators", "lb");
t.add("This is not a valid UUID.", "D\u00ebse W\u00e4ert ass keng g\u00fclteg UUID.", "validators", "lb");
...
t.add("This value should be a valid expression.", "D\u00ebse W\u00e4ert soll eng g\u00eblteg Expression sinn.", "validators", "lb");
t.add("This value is not a valid CSS color.", "D\u00ebse W\u00e4ert ass keng g\u00eblteg CSS Faarf.", "validators", "lb");
t.add("This value is not a valid CIDR notation.", "D\u00ebse W\u00e4ert ass keng g\u00eblteg CIDR Notatioun.", "validators", "lb");
t.add("The value of the netmask should be between {{ min }} and {{ max }}.", "De W\u00e4ert vum Netmask soll t\u00ebscht {{ min }} a {{ max }} sinn.", "validators", "lb");
t.add("The filename is too long. It should have {{ filename_max_length }} character or less.|The filename is too long. It should have {{ filename_max_length }} characters or less.", "De Dateinimm ass ze laang. Et sollt {{ filename_max_length }} Zeechen oder manner hunn.|De Dateinimm ass ze laang. Et sollt {{ filename_max_length }} Zeechen oder manner hunn.", "validators", "lb");
t.add("The password strength is too low. Please use a stronger password.", "D'Staarf vum Passwuert ass ze schwaach. Benotzt w. e. g. e st\u00e4erker Passwuert.", "validators", "lb");
t.add("This value contains characters that are not allowed by the current restriction-level.", "D\u00ebse W\u00e4ert enth\u00e4lt Zeechen, d\u00e9i net erlaabt sinn no der aktueller Beschr\u00e4nkungsstuf.", "validators", "lb");
t.add("Using invisible characters is not allowed.", "D'Benotzen vu onsiichtbaren Zeechen ass net erlaabt.", "validators", "lb");
t.add("Mixing numbers from different scripts is not allowed.", "D'M\u00ebsche vu Nummeren aus verschiddenen Skripten ass net erlaabt.", "validators", "lb");
t.add("Using hidden overlay characters is not allowed.", "D'Benotzen vu verstoppten Iwwerlagungszeechen ass net erlaabt.", "validators", "lb");
t.add("The extension of the file is invalid ({{ extension }}). Allowed extensions are {{ extensions }}.", "D'Extensioun vum Fichier ass net valabel ({{ extension }}). Valabel Extensioune sinn {{ extensions }}.", "validators", "lb");
t.add("The detected character encoding is invalid ({{ detected }}). Allowed encodings are {{ encodings }}.", "Den Encodage vun de Schr\u00ebftzeechen ass net valabel ({{ detected }}). Valabel Encodage sinn {{ encodings }}.", "validators", "lb");
t.add("This value is not a valid MAC address.", "D\u00ebse W\u00e4ert ass keng g\u00fclteg MAC-Adress.", "validators", "lb");
t.add("This URL is missing a top-level domain.", "D\u00ebsen URL feelt eng Top-Level-Domain.", "validators", "lb");
t.add("This value is too short. It should contain at least one word.|This value is too short. It should contain at least {{ min }} words.", "This value is too short. It should contain at least one word.|This value is too short. It should contain at least {{ min }} words.", "validators", "lb");
t.add("This value is too long. It should contain one word.|This value is too long. It should contain {{ max }} words or less.", "This value is too long. It should contain one word.|This value is too long. It should contain {{ max }} words or less.", "validators", "lb");
t.add("This value does not represent a valid week in the ISO 8601 format.", "This value does not represent a valid week in the ISO 8601 format.", "validators", "lb");
t.add("This value is not a valid week.", "This value is not a valid week.", "validators", "lb");
t.add("This value should not be before week \"{{ min }}\".", "This value should not be before week \"{{ min }}\".", "validators", "lb");
t.add("This value should not be after week \"{{ max }}\".", "This value should not be after week \"{{ max }}\".", "validators", "lb");
...
t.add("This value is not a valid HTML5 color.", "D\u00ebse W\u00e4ert ass keng g\u00eblteg HTML5-Faarf.", "validators", "lb");
t.add("Please enter a valid birthdate.", "W.e.g. e g\u00ebltege Gebuertsdatum aginn.", "validators", "lb");
t.add("The selected choice is invalid.", "Den ausgewielte Choix ass ong\u00eblteg.", "validators", "lb");
t.add("The collection is invalid.", "D'Kollektioun ass ong\u00eblteg.", "validators", "lb");
t.add("Please select a valid color.", "W.e.g. eng g\u00eblteg Faarf auswielen.", "validators", "lb");
t.add("Please select a valid country.", "W.e.g. e g\u00ebltegt Land auswielen.", "validators", "lb");
t.add("Please select a valid currency.", "W.e.g. eng g\u00eblteg W\u00e4rung auswielen.", "validators", "lb");
t.add("Please choose a valid date interval.", "W.e.g. e g\u00ebltegen Datumsinterval aginn.", "validators", "lb");
t.add("Please enter a valid date and time.", "W.e.g. eng g\u00eblteg Datum an Z\u00e4it aginn.", "validators", "lb");
t.add("Please enter a valid date.", "W.e.g. eng g\u00ebltegen Datum aginn.", "validators", "lb");
t.add("Please select a valid file.", "W.e.g. e g\u00ebltege Fichier auswielen.", "validators", "lb");
t.add("The hidden field is invalid.", "Dat verstoppte Feld ass ong\u00eblteg.", "validators", "lb");
t.add("Please enter an integer.", "W.e.g. eng ganz Zuel aginn.", "validators", "lb");
t.add("Please select a valid language.", "W.e.g. e g\u00ebltegt Sprooch auswielen.", "validators", "lb");
t.add("Please select a valid locale.", "W.e.g. e g\u00ebltegt Regionalschema auswielen.", "validators", "lb");
t.add("Please enter a valid money amount.", "W.e.g. eng g\u00eblteg Geldzomm aginn.", "validators", "lb");
t.add("Please enter a number.", "W.e.g. eng Zuel aginn.", "validators", "lb");
t.add("The password is invalid.", "D'Passwuert ass ong\u00eblteg.", "validators", "lb");
t.add("Please enter a percentage value.", "W.e.g. e Prozentw\u00e4ert aginn.", "validators", "lb");
t.add("The values do not match.", "D'W\u00e4erter st\u00ebmmen net iwwereneen.", "validators", "lb");
t.add("Please enter a valid time.", "W.e.g. eng g\u00eblteg Z\u00e4it aginn.", "validators", "lb");
t.add("Please select a valid timezone.", "W.e.g. eng g\u00eblteg Z\u00e4itzon auswielen.", "validators", "lb");
t.add("Please enter a valid URL.", "W.e.g. eng g\u00eblteg URL aginn.", "validators", "lb");
t.add("Please enter a valid search term.", "W.e.g. e g\u00ebltege Sichbegr\u00ebff aginn.", "validators", "lb");
t.add("Please provide a valid phone number.", "W.e.g. eng g\u00eblteg Telefonsnummer uginn.", "validators", "lb");
t.add("The checkbox has an invalid value.", "D'Ukr\u00e4izfeld huet en ong\u00ebltege W\u00e4ert.", "validators", "lb");
t.add("Please enter a valid email address.", "W.e.g. eng g\u00eblteg E-Mail-Adress aginn.", "validators", "lb");
t.add("Please select a valid option.", "W.e.g. eng g\u00eblteg Optioun auswielen.", "validators", "lb");
t.add("Please select a valid range.", "W.e.g. eng g\u00eblteg Spannbreet auswielen.", "validators", "lb");
t.add("Please enter a valid week.", "W.e.g. eng g\u00eblteg Woch aginn.", "validators", "lb");
})(Translator);
