...
(function (global, doc, ibexa, Translator, bootstrap, moment) {
  ...
  if (autosaveNode) {
    ...
    var setDraftSavedMessage = function setDraftSavedMessage(autosaveStatusSavedNode) {
      ...
      var saveMessage = Translator.trans(/*@Desc("Autosave is on, draft saved %time%")*/'content_edit.autosave.status_saved.message.full', {
        time: saveTime
      }, 'ibexa_content');
...
(function (global, doc, ibexa) {
  ...
  var BaseFileFieldValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function BaseFileFieldValidator() {
      ...
      return _callSuper(this, BaseFileFieldValidator, arguments);
    }
    _inherits(BaseFileFieldValidator, _ibexa$BaseFieldValid);
    return _createClass(BaseFileFieldValidator, [{
      key: "validateInput",
      value:
      /**
       * Validates the input
      ...
      function validateInput(event) {
        ...
        var _input$dataset$allowe = input.dataset.allowedFileTypes,
          allowedFileTypes = _input$dataset$allowe === void 0 ? [] : _input$dataset$allowe;
      ...
      key: "showFileTypeError",
      value: function showFileTypeError() {
        var label = this.fieldContainer.querySelector(SELECTOR_FIELD_LABEL).innerHTML;
        var result = {
          isError: true,
...
(function (global, doc, ibexa) {
  ...
  var BasePreviewField = /*#__PURE__*/function () {
     ...
     */
    return _createClass(BasePreviewField, [{
      key: "formatFileSize",
...
(function (global, doc, ibexa) {
  var MultiInputFieldValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function MultiInputFieldValidator(_ref) {
      ...
      _this = _callSuper(this, MultiInputFieldValidator, [restProps]);
      _this.containerSelectors = containerSelectors;
      return _this;
    }
    _inherits(MultiInputFieldValidator, _ibexa$BaseFieldValid);
    return _createClass(MultiInputFieldValidator, [{
      key: "toggleInvalidState",
      value: function toggleInvalidState(isError, config, input) {
        var _this2 = this;
        _superPropGet(MultiInputFieldValidator, "toggleInvalidState", this, 3)([isError, config, input]);
...
(function (global, doc, ibexa) {
  ...
  var EzAuthorValidator = /*#__PURE__*/function (_ibexa$MultiInputFiel) {
    ...
    function EzAuthorValidator() {
      ...
      return _callSuper(this, EzAuthorValidator, arguments);
    }
    _inherits(EzAuthorValidator, _ibexa$MultiInputFiel);
    return _createClass(EzAuthorValidator, [{
      key: "validateName",
      value:
      /**
      ...
      value: function init() {
        var _this = this;
        _superPropGet(EzAuthorValidator, "init", this, 3)([]);
...
(function (global, doc, ibexa) {
  ...
  var EzBinaryFilePreviewField = /*#__PURE__*/function (_ibexa$BasePreviewFie) {
    ...
    function EzBinaryFilePreviewField() {
      ...
      return _callSuper(this, EzBinaryFilePreviewField, arguments);
    }
    _inherits(EzBinaryFilePreviewField, _ibexa$BasePreviewFie);
    return _createClass(EzBinaryFilePreviewField, [{
      key: "loadDroppedFilePreview",
      value:
      /**
       * Loads dropped file preview
      ...
      function loadDroppedFilePreview(event) {
        ...
        var escapeHTML = ibexa.helpers.text.escapeHTML;
        var fileName = escapeHTML(files[0].name);
...
(function (global, doc, ibexa) {
  ...
  var EzBooleanValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzBooleanValidator() {
      ...
      return _callSuper(this, EzBooleanValidator, arguments);
    }
    _inherits(EzBooleanValidator, _ibexa$BaseFieldValid);
    return _createClass(EzBooleanValidator, [{
      key: "validateInput",
      value:
      /**
      ...
      function validateInput(event) {
        ...
        var label = event.target.closest(SELECTOR_FIELD).querySelector(SELECTOR_LABEL).innerText;
...
(function (global, doc, ibexa) {
  ...
  var EzCountryValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzCountryValidator() {
      ...
      return _callSuper(this, EzCountryValidator, arguments);
    }
    _inherits(EzCountryValidator, _ibexa$BaseFieldValid);
    return _createClass(EzCountryValidator, [{
      key: "validateInput",
      value:
      /**
...
(function (global, doc, ibexa) {
  ...
  var EzDateValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzDateValidator() {
      ...
      return _callSuper(this, EzDateValidator, arguments);
    }
    _inherits(EzDateValidator, _ibexa$BaseFieldValid);
    return _createClass(EzDateValidator, [{
      key: "validateInput",
      value:
      /**
       * Validates the input
...
(function (global, doc, ibexa) {
  ...
  var EzDateTimeValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzDateTimeValidator() {
      ...
      return _callSuper(this, EzDateTimeValidator, arguments);
    }
    _inherits(EzDateTimeValidator, _ibexa$BaseFieldValid);
    return _createClass(EzDateTimeValidator, [{
      key: "validateInput",
      value:
      /**
       * Validates the input
...
(function (global, doc, ibexa) {
  ...
  var EzEmailValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzEmailValidator() {
      ...
      return _callSuper(this, EzEmailValidator, arguments);
    }
    _inherits(EzEmailValidator, _ibexa$BaseFieldValid);
    return _createClass(EzEmailValidator, [{
      key: "validateInput",
      value:
      /**
       * Validates the input
      ...
      function validateInput(event) {
        ...
        var isValid = ibexa.errors.emailRegexp.test(input.value);
        var isError = isRequired && isEmpty || !isEmpty && !isValid;
        var label = input.closest(SELECTOR_FIELD).querySelector(SELECTOR_LABEL).innerText;
        var result = {
          isError: isError
        };
        if (isRequired && isEmpty) {
...
(function (global, doc, ibexa) {
  ...
  var EzFloatValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzFloatValidator() {
      ...
      return _callSuper(this, EzFloatValidator, arguments);
    }
    _inherits(EzFloatValidator, _ibexa$BaseFieldValid);
    return _createClass(EzFloatValidator, [{
      key: "validateFloat",
      value:
      /**
       * Validates the input
...
(function (global, doc, ibexa, Leaflet, Translator) {
  ...
  var EzGMapLocationValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzGMapLocationValidator() {
      ...
      return _callSuper(this, EzGMapLocationValidator, arguments);
    }
    _inherits(EzGMapLocationValidator, _ibexa$BaseFieldValid);
    return _createClass(EzGMapLocationValidator, [{
      ...
      value: function validateField(config, event) {
        ...
        this.toggleErrorMessage(validationResult, config, event.target);
        if (validationResult.isError) {
          var errorMessage = Translator.trans(/* @Desc("Area above needs correction") */'ezmaplocation.create.message.error', {}, 'ibexa_fieldtypes_edit');
          var allFieldsResult = {
            isError: true,
            errorMessage: errorMessage
          };
  ...
  doc.querySelectorAll('.ibexa-tabs--content .nav-link').forEach(function (tab) {
...
(function (global, doc, ibexa, Translator) {
  ...
  var EzImageFilePreviewField = /*#__PURE__*/function (_ibexa$BasePreviewFie) {
    ...
    function EzImageFilePreviewField() {
      ...
      return _callSuper(this, EzImageFilePreviewField, arguments);
    }
    _inherits(EzImageFilePreviewField, _ibexa$BasePreviewFie);
    return _createClass(EzImageFilePreviewField, [{
      key: "getImageUrl",
      value:
      /**
      ...
      key: "resetInputField",
      value: function resetInputField() {
        _superPropGet(EzImageFilePreviewField, "resetInputField", this, 3)([]);
  ...
  var EzImageFieldValidator = /*#__PURE__*/function (_ibexa$BaseFileFieldV) {
    ...
    function EzImageFieldValidator() {
      ...
      return _callSuper(this, EzImageFieldValidator, arguments);
    }
    _inherits(EzImageFieldValidator, _ibexa$BaseFileFieldV);
    return _createClass(EzImageFieldValidator, [{
      ...
      function validateAltInput(event) {
        ...
        var label = event.target.closest(SELECTOR_ALT_WRAPPER).querySelector('.ibexa-data-source__label').innerText;
        var result = {
          isError: isError
        };
        if (isEmpty) {
  ...
  doc.querySelectorAll(SELECTOR_FIELD).forEach(function (fieldContainer) {
    ...
    var inputFileFieldContainer = fieldContainer.querySelector(SELECTOR_INPUT_FILE);
    var _inputFileFieldContai = inputFileFieldContainer.dataset.allowedFileTypes,
      allowedFileTypes = _inputFileFieldContai === void 0 ? [] : _inputFileFieldContai;
...
(function (global, doc, ibexa, React, ReactDOM, Translator, Routing) {
  ...
  var EzImageAssetPreviewField = /*#__PURE__*/function (_ibexa$BasePreviewFie) {
    ...
    function EzImageAssetPreviewField(props) {
      ...
      _this = _callSuper(this, EzImageAssetPreviewField, [props]);
    ...
    return _createClass(EzImageAssetPreviewField, [{
      key: "createAsset",
      ...
      value: function onAssetCreateSuccess(response) {
        ...
        showSuccessNotification(Translator.trans(/* @Desc("The image has been published and can now be reused") */'ezimageasset.create.message.success', {}, 'ibexa_fieldtypes_edit'));
      }
      ...
      value: function loadAsset(response) {
        ...
        if (imageField.fieldValue === null) {
          showErrorNotification(Translator.trans(/* @Desc("The chosen asset has no image data available.") */'ezimageasset.empty_data.message.error', {}, 'ibexa_fieldtypes_edit'));
          return;
        }
      ...
      value: function openUDW(event) {
        ...
        var title = Translator.trans(/*@Desc("Select Image Asset")*/'ezimageasset.title', {}, 'ibexa_universal_discovery_widget');
      ...
      key: "resetInputField",
      value: function resetInputField() {
        _superPropGet(EzImageAssetPreviewField, "resetInputField", this, 3)([]);
      ...
      key: "init",
      value: function init() {
        _superPropGet(EzImageAssetPreviewField, "init", this, 3)([]);
...
(function (global, doc, ibexa) {
  ...
  var EzIntegerValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzIntegerValidator() {
      ...
      return _callSuper(this, EzIntegerValidator, arguments);
    }
    _inherits(EzIntegerValidator, _ibexa$BaseFieldValid);
    return _createClass(EzIntegerValidator, [{
      key: "validateInteger",
      value:
      /**
       * Validates the input
...
(function (global, doc, ibexa) {
  ...
  var EzKeywordValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    return _createClass(EzKeywordValidator, [{
      ...
      function validateKeywords(event) {
        ...
        var label = fieldContainer.querySelector(SELECTOR_LABEL).innerText;
        var isRequired = input.required;
  ...
  doc.querySelectorAll(SELECTOR_FIELD).forEach(function (field) {
    ...
    var taggifyInput = taggifyContainer.querySelector('.ibexa-taggify__input');
...
(function (global, doc, ibexa) {
  ...
  var EzMediaValidator = /*#__PURE__*/function (_ibexa$BaseFileFieldV) {
    ...
    function EzMediaValidator() {
      ...
      return _callSuper(this, EzMediaValidator, arguments);
    }
    _inherits(EzMediaValidator, _ibexa$BaseFileFieldV);
    return _createClass(EzMediaValidator, [{
      ...
      function validateDimensions(event) {
        ...
        var label = input.closest(SELECTOR_INFO_WRAPPER).querySelector('.ibexa-field-edit-preview__label').innerText;
        var result = {
          isError: isError
        };
        if (isEmpty) {
  ...
  var EzMediaPreviewField = /*#__PURE__*/function (_ibexa$BasePreviewFie) {
    ...
    function EzMediaPreviewField() {
      ...
      return _callSuper(this, EzMediaPreviewField, arguments);
    }
    _inherits(EzMediaPreviewField, _ibexa$BasePreviewFie);
    return _createClass(EzMediaPreviewField, [{
      key: "loadDroppedFilePreview",
      value:
      /**
       * Loads dropped file preview
      ...
      key: "handleRemoveFile",
      value: function handleRemoveFile(event) {
        _superPropGet(EzMediaPreviewField, "handleRemoveFile", this, 3)([event]);
      ...
      key: "init",
      value: function init() {
        _superPropGet(EzMediaPreviewField, "init", this, 3)([]);
        var preview = this.fieldContainer.querySelector(SELECTOR_PREVIEW);
...
(function (global, doc, ibexa, React, ReactDOM, Translator) {
  ...
  var EzObjectRelationListValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzObjectRelationListValidator() {
      ...
      return _callSuper(this, EzObjectRelationListValidator, arguments);
    }
    _inherits(EzObjectRelationListValidator, _ibexa$BaseFieldValid);
    return _createClass(EzObjectRelationListValidator, [{
      key: "validateInput",
      value:
      /**
       * Validates the input
  ...
  [].concat(_toConsumableArray(doc.querySelectorAll(SELECTOR_FIELD_MULTIPLE)), _toConsumableArray(doc.querySelectorAll(SELECTOR_FIELD_SINGLE))).forEach(function (fieldContainer) {
    ...
    var renderRows = function renderRows(items) {
      items.forEach(function (item, index) {
        ...
        var VersionInfo = item.ContentInfo.Content.CurrentVersion.Version.VersionInfo;
        var currentVersionNo = VersionInfo.versionNo;
        var languageCodes = VersionInfo.VersionTranslationInfo.Language.map(function (language) {
          return language.languageCode;
        });
        var itemActionsMenuContainer = itemNode.querySelector('.ibexa-embedded-item-actions__menu');
...
/* harmony import */ var _validator_richtext_validator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validator/richtext-validator */ "./vendor/ibexa/admin-ui/src/bundle/Resources/public/js/scripts/fieldType/validator/richtext-validator.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
(function (global, doc, ibexa, React, ReactDOM) {
  ...
  doc.querySelectorAll("".concat(SELECTOR_FIELD, " ").concat(SELECTOR_INPUT)).forEach(function (container) {
    ...
    var validator = (0,_validator_richtext_validator__WEBPACK_IMPORTED_MODULE_0__["default"])(container, SELECTOR_FIELD, SELECTOR_ERROR_NODE, SELECTOR_INPUT, SELECTOR_LABEL, richtextEditor);
    ibexa.addConfig('fieldTypeValidators', [validator], true);
  });
...
(function (global, doc, ibexa) {
  ...
  var EzSelectionValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzSelectionValidator() {
      ...
      return _callSuper(this, EzSelectionValidator, arguments);
    }
    _inherits(EzSelectionValidator, _ibexa$BaseFieldValid);
    return _createClass(EzSelectionValidator, [{
      key: "validateInput",
      value:
      /**
...
(function (global, doc, ibexa) {
  ...
  var EzStringValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzStringValidator() {
      ...
      return _callSuper(this, EzStringValidator, arguments);
    }
    _inherits(EzStringValidator, _ibexa$BaseFieldValid);
    return _createClass(EzStringValidator, [{
      key: "validateInput",
      value:
      /**
       * Validates the input
      ...
      function validateInput(event) {
        ...
        var isError = isEmpty && isRequired || !isEmpty && (isTooShort || isTooLong);
        var label = event.target.closest(SELECTOR_FIELD).querySelector(SELECTOR_LABEL).innerText;
        var result = {
          isError: isError
        };
...
(function (global, doc, ibexa) {
  ...
  var EzTextValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzTextValidator() {
      ...
      return _callSuper(this, EzTextValidator, arguments);
    }
    _inherits(EzTextValidator, _ibexa$BaseFieldValid);
    return _createClass(EzTextValidator, [{
      key: "validateInput",
      value:
      /**
       * Validates the textarea field value
...
(function (global, doc, ibexa) {
  ...
  var EzTimeValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzTimeValidator() {
      ...
      return _callSuper(this, EzTimeValidator, arguments);
    }
    _inherits(EzTimeValidator, _ibexa$BaseFieldValid);
    return _createClass(EzTimeValidator, [{
      key: "validateInput",
      value:
      /**
       * Validates the input
...
(function (global, doc, ibexa) {
  ...
  var EzUrlValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzUrlValidator() {
      ...
      return _callSuper(this, EzUrlValidator, arguments);
    }
    ...
    return _createClass(EzUrlValidator, [{
      ...
      value: function validateUrl(event) {
        ...
        var label = input.closest(SELECTOR_FIELD_LINK).querySelector(SELECTOR_LABEL).innerText;
        if (isRequired && isEmpty) {
          result.isError = true;
          result.errorMessage = ibexa.errors.emptyField.replace('{fieldName}', label);
        }
...
(function (global, doc, ibexa) {
  ...
  var EzUserValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzUserValidator() {
      ...
      return _callSuper(this, EzUserValidator, arguments);
    }
    _inherits(EzUserValidator, _ibexa$BaseFieldValid);
    return _createClass(EzUserValidator, [{
      key: "validateInput",
      value:
      /**
       * Validates the input field value
...
/***/ "./vendor/ibexa/admin-ui/src/bundle/Resources/public/js/scripts/fieldType/ibexa_isbn.js"
/*!**********************************************************************************************!*\
  !*** ./vendor/ibexa/admin-ui/src/bundle/Resources/public/js/scripts/fieldType/ibexa_isbn.js ***!
  \**********************************************************************************************/
() {
...
function _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); }
(function (global, doc, ibexa) {
  var SELECTOR_FIELD = '.ibexa-field-edit--ezisbn';
  var SELECTOR_SOURCE_INPUT = '.ibexa-data-source__input';
  var SELECTOR_LABEL = '.ibexa-field-edit__label';
  var IbexaIsbnValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    "use strict";

    function IbexaIsbnValidator() {
      _classCallCheck(this, IbexaIsbnValidator);
      return _callSuper(this, IbexaIsbnValidator, arguments);
    }
    _inherits(IbexaIsbnValidator, _ibexa$BaseFieldValid);
    return _createClass(IbexaIsbnValidator, [{
      key: "validateInput",
      value:
      /**
       * Validates the input
  ...
  var validator = new IbexaIsbnValidator({
    classInvalid: 'is-invalid',
    fieldSelector: SELECTOR_FIELD,
    eventsMap: [{
...
(function (global, doc, Translator, bootstrap, ibexa, Routing) {
  ...
  var EzDamExtension = /*#__PURE__*/function () {
    ...
    return _createClass(EzDamExtension, [{
      key: "getFormData",
      ...
      value: function refreshPagination(results) {
        ...
        var pages = ibexa.helpers.pagination.computePages({
          activePageIndex: this.activePage,
      ...
      value: function showError() {
        ...
        contentContainer.innerHTML = Translator.trans(/*@Desc("Something went wrong.")*/'dam.error.message', {}, 'ibexa_connector_dam_ui');
...
/***/ "./vendor/ibexa/fieldtype-address/src/bundle/Resources/public/js/scripts/fieldType/ibexa_address.js"
/*!**********************************************************************************************************!*\
  !*** ./vendor/ibexa/fieldtype-address/src/bundle/Resources/public/js/scripts/fieldType/ibexa_address.js ***!
  \**********************************************************************************************************/
() {
...
(function (global, doc, ibexa, Routing) {
  var ADDRESS_FORM_LOADED_EVENT = 'ibexa-fieldtype-address:form-loaded';
  var addressFields = doc.querySelectorAll('.ibexa-field-edit--ibexa_address');
  ...
  var getLoaderElement = function getLoaderElement(addressWrapper) {
    var template = addressWrapper.dataset.dropdownLoaderTemplate;
    var container = doc.createElement('div');
    container.insertAdjacentHTML('beforeend', template);
    return container.firstElementChild;
  };
  var blockAddressFields = function blockAddressFields(addressWrapper) {
    var form = addressWrapper.closest('form');
    var allFormFields = _toConsumableArray(form.elements);
    var addressFormFields = allFormFields.filter(function (formField) {
      return addressWrapper.contains(formField);
    });
    addressFormFields.forEach(function (formField) {
      formField.disabled = true;
    });
  };
  var replaceFormOnCountryChange = function replaceFormOnCountryChange(country, _ref) {
    var dataSourceNode = _ref.dataSourceNode,
      dropdownNode = _ref.dropdownNode;
    var formNode = dataSourceNode.querySelector('.ibexa-data-source__fields-wrapper');
    var _formNode$dataset = formNode.dataset,
      formIntent = _formNode$dataset.formIntent,
      ...
      contentId = _formNode$dataset.contentId,
      formName = _formNode$dataset.formName;
    var selectedItem = dropdownNode.querySelector('.ibexa-dropdown__selected-item');
    var loader = getLoaderElement(formNode);
    blockAddressFields(formNode);
    selectedItem.appendChild(loader);
    var countryFormLink = formIntent === 'update' ? Routing.generate('ibexa.address.country.form.update', {
    ...
    fetch(countryFormLink, {
      mode: 'same-origin',
      credentials: 'same-origin'
    }).then(ibexa.helpers.request.getTextFromResponse).then(getHtmlFromResponse).then(function (htmlResponse) {
      loader.remove();
      formNode.replaceWith(htmlResponse);
      doc.body.dispatchEvent(new CustomEvent(ADDRESS_FORM_LOADED_EVENT));
    })["catch"](ibexa.helpers.notification.showErrorNotification);
  };
  var attachChangeCountryEvents = function attachChangeCountryEvents(addressField) {
    var countryField = addressField.querySelector('.ibexa-data-source__field--country');
    var countryDropdown = countryField.querySelector('.ibexa-data-source__country-dropdown');
    var dataSourceNode = addressField.querySelector('.ibexa-data-source');
    var countryDropdownInstance = new ibexa.core.Dropdown({
      container: countryDropdown
    });
    countryDropdownInstance.init();
    countryDropdownInstance.sourceInput.addEventListener('change', function (_ref2) {
...
/***/ "./vendor/ibexa/fieldtype-address/src/bundle/Resources/public/js/scripts/fieldType/ibexa_address_validation.js"
/*!*********************************************************************************************************************!*\
  !*** ./vendor/ibexa/fieldtype-address/src/bundle/Resources/public/js/scripts/fieldType/ibexa_address_validation.js ***!
  \*********************************************************************************************************************/
() {
...
function _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); }
(function (global, doc, ibexa, Translator) {
  var SELECTOR_FIELD = '.ibexa-field-edit--ibexa_address';
  var SELECTOR_LABEL = '.ibexa-data-source__label';
  var SELECTOR_ERROR_NODE = '.ibexa-form-error';
  var SELECTOR_FIELD_NAME = ".ibexa-data-source__field--name";
  var SELECTOR_FIELD_COUNTRY = '.ibexa-data-source__field--country';
  var SELECTOR_FIELD_REGION = ".ibexa-data-source__field--region";
  var SELECTOR_FIELD_CITY = '.ibexa-data-source__field--locality';
  var SELECTOR_FIELD_STREET = '.ibexa-data-source__field--street';
  var SELECTOR_FIELD_POSTAL_CODE = '.ibexa-data-source__field--postal_code';
  var IbexaAddressValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    "use strict";

    function IbexaAddressValidator() {
      _classCallCheck(this, IbexaAddressValidator);
      return _callSuper(this, IbexaAddressValidator, arguments);
    }
    _inherits(IbexaAddressValidator, _ibexa$BaseFieldValid);
    return _createClass(IbexaAddressValidator, [{
      key: "validateInput",
      value: function validateInput(event) {
        var _event$target$labels$, _event$target$labels$2;
        var result = {
          isError: false,
          errorMessage: null
        };
        ...
        var label = (_event$target$labels$ = (_event$target$labels$2 = event.target.labels[0]) === null || _event$target$labels$2 === void 0 ? void 0 : _event$target$labels$2.innerText) !== null && _event$target$labels$ !== void 0 ? _event$target$labels$ : Translator.trans(/* @Desc("This") */'ibexa.address.validation.this', {}, 'ibexa_fieldtype_address');
        if (isRequired && isEmpty) {
          result.isError = true;
          result.errorMessage = ibexa.errors.emptyField.replace('{fieldName}', label);
        }
      ...
      value: function validateSelector(event) {
        var result = {
          isError: false,
          errorMessage: null
        };
        var input = event.currentTarget;
        var fieldContainer = event.currentTarget.closest('.ibexa-data-source__field--country');
        var isSelectRequired = fieldContainer.classList.contains('ibexa-data-source__field--required');
        var hasValue = !!input.value;
        var label = fieldContainer.querySelector('.ibexa-data-source__label').innerText;
        if (isSelectRequired && !hasValue) {
          result.isError = true;
          result.errorMessage = ibexa.errors.emptyField.replace('{fieldName}', label);
        }
        return result;
  ...
  var validator = new IbexaAddressValidator({
    classInvalid: 'is-invalid',
    fieldSelector: SELECTOR_FIELD,
    eventsMap: [{
      selector: "".concat(SELECTOR_FIELD, " ").concat(SELECTOR_FIELD_NAME, " .ibexa-data-source__input"),
      eventName: 'blur',
      callback: 'validateInput',
      invalidStateSelectors: ["".concat(SELECTOR_FIELD_NAME, " ").concat(SELECTOR_LABEL)],
      errorNodeSelectors: ["".concat(SELECTOR_FIELD_NAME, " ").concat(SELECTOR_ERROR_NODE)]
    }, {
      selector: "".concat(SELECTOR_FIELD, " ").concat(SELECTOR_FIELD_COUNTRY, " .ibexa-data-source__input"),
      eventName: 'change',
      callback: 'validateSelector',
      invalidStateSelectors: ["".concat(SELECTOR_FIELD_COUNTRY, " ").concat(SELECTOR_LABEL)],
      errorNodeSelectors: ["".concat(SELECTOR_FIELD_COUNTRY, " ").concat(SELECTOR_ERROR_NODE)]
    }, {
      selector: "".concat(SELECTOR_FIELD, " ").concat(SELECTOR_FIELD_REGION, " .ibexa-data-source__input"),
      eventName: 'blur',
      callback: 'validateInput',
      invalidStateSelectors: ["".concat(SELECTOR_FIELD_REGION, " ").concat(SELECTOR_LABEL)],
      errorNodeSelectors: ["".concat(SELECTOR_FIELD_REGION, " ").concat(SELECTOR_ERROR_NODE)]
    }, {
      selector: "".concat(SELECTOR_FIELD, " ").concat(SELECTOR_FIELD_CITY, " .ibexa-data-source__input"),
      eventName: 'blur',
      callback: 'validateInput',
      invalidStateSelectors: ["".concat(SELECTOR_FIELD_CITY, " ").concat(SELECTOR_LABEL)],
      errorNodeSelectors: ["".concat(SELECTOR_FIELD_CITY, " ").concat(SELECTOR_ERROR_NODE)]
    }, {
      selector: "".concat(SELECTOR_FIELD, " ").concat(SELECTOR_FIELD_STREET, " .ibexa-data-source__input"),
      eventName: 'blur',
      callback: 'validateInput',
      invalidStateSelectors: ["".concat(SELECTOR_FIELD_STREET, " ").concat(SELECTOR_LABEL)],
      errorNodeSelectors: ["".concat(SELECTOR_FIELD_STREET, " ").concat(SELECTOR_ERROR_NODE)]
    }, {
      selector: "".concat(SELECTOR_FIELD, " ").concat(SELECTOR_FIELD_POSTAL_CODE, " .ibexa-data-source__input"),
      eventName: 'blur',
      callback: 'validateInput',
      invalidStateSelectors: ["".concat(SELECTOR_FIELD_POSTAL_CODE, " ").concat(SELECTOR_LABEL)],
      errorNodeSelectors: ["".concat(SELECTOR_FIELD_POSTAL_CODE, " ").concat(SELECTOR_ERROR_NODE)]
    }]
  });
  validator.init();
  doc.body.addEventListener('ibexa-fieldtype-address:form-loaded', function () {
    validator.reinit();
  }, false);
  ibexa.addConfig('fieldTypeValidators', [validator], true);
})(window, window.document, window.ibexa, window.Translator);
...
(function (global, doc, ibexa) {
  ...
  var EzMatrixValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function EzMatrixValidator() {
      ...
      return _callSuper(this, EzMatrixValidator, arguments);
    }
    _inherits(EzMatrixValidator, _ibexa$BaseFieldValid);
    return _createClass(EzMatrixValidator, [{
      key: "addItem",
      value:
      /**
       * Adds an item.
      ...
      key: "validateMinimumRows",
      value: function validateMinimumRows(event) {
        var matrixNode = event.target.closest(SELECTOR_FIELD);
        var container = matrixNode.querySelector(SELECTOR_MATRIX_ENTRIES_CONTAINER);
        var minimumRows = parseInt(container.dataset.minimumRows, 10);
        var filledRows = _toConsumableArray(matrixNode.querySelectorAll(SELECTOR_MATRIX_ENTRY)).filter(function (entry) {
          return _toConsumableArray(entry.querySelectorAll('input[type="text"]')).some(function (input) {
            return input.value.trim();
          });
        });
        var isError = filledRows.length < minimumRows;
        var label = matrixNode.querySelector('.ibexa-field-edit__label').innerText;
        var errorMessage = ibexa.errors.emptyField.replace('{fieldName}', label);
        return {
          isError: isError,
          errorMessage: errorMessage
      ...
      value: function init() {
        var _this = this;
        _superPropGet(EzMatrixValidator, "init", this, 3)([]);
        doc.querySelectorAll(this.fieldSelector).forEach(function (field) {
  ...
  var validator = new EzMatrixValidator({
    ...
    fieldSelector: SELECTOR_FIELD,
    eventsMap: [{
      selector: "".concat(SELECTOR_FIELD, " ").concat(SELECTOR_MATRIX_ENTRY, " input[type=\"text\"]"),
      eventName: 'blur',
      callback: 'validateMinimumRows',
      errorNodeSelectors: ["".concat(SELECTOR_FIELD, " .ibexa-form-error")],
      invalidStateSelectors: ["".concat(SELECTOR_FIELD, " .ibexa-field-edit__label")]
    }, {
      isValueValidator: false,
...
(function (global, doc, ibexa, React, ReactDOM, Routing) {
  ...
  var openImageEditor = function openImageEditor(event) {
    ...
    var setNewImage = function setNewImage(image, additionalData, saveAsNew, closeEditorAfterSave) {
...
/***/ "./vendor/ibexa/taxonomy/src/bundle/Resources/public/js/fieldType/ibexa_taxonomy_entry.js"
/*!************************************************************************************************!*\
  !*** ./vendor/ibexa/taxonomy/src/bundle/Resources/public/js/fieldType/ibexa_taxonomy_entry.js ***!
  \************************************************************************************************/
() {
...
function _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); }
(function (global, doc, ibexa) {
  var SELECTOR_FIELD = '.ibexa-field-edit--ibexa_taxonomy_entry';
  ...
  var IbexaTaxonomyEntryValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    "use strict";

    function IbexaTaxonomyEntryValidator() {
      _classCallCheck(this, IbexaTaxonomyEntryValidator);
      return _callSuper(this, IbexaTaxonomyEntryValidator, arguments);
    }
    _inherits(IbexaTaxonomyEntryValidator, _ibexa$BaseFieldValid);
    return _createClass(IbexaTaxonomyEntryValidator, [{
      key: "validateEntries",
  ...
  var validator = new IbexaTaxonomyEntryValidator({
    classInvalid: 'is-invalid',
    fieldSelector: SELECTOR_FIELD,
    eventsMap: [{
      selector: "".concat(SELECTOR_FIELD, " ").concat(SELECTOR_INPUT),
...
(function (global, doc, ibexa) {
  ...
  var IbexaTaxonomyEntryAssignmentValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    ...
    function IbexaTaxonomyEntryAssignmentValidator() {
      ...
      return _callSuper(this, IbexaTaxonomyEntryAssignmentValidator, arguments);
    }
    _inherits(IbexaTaxonomyEntryAssignmentValidator, _ibexa$BaseFieldValid);
    return _createClass(IbexaTaxonomyEntryAssignmentValidator, [{
      key: "validateEntries",
      value: function validateEntries(event) {
        var input = event.target;
        var isRequired = input.required;
