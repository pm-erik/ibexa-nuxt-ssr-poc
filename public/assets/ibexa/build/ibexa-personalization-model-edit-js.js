...
(function (doc, ibexa, Translator) {
  ...
  var _dropItemOnEmptyGroup = function dropItemOnEmptyGroup(event) {
    event.stopPropagation();
    ...
    group.removeEventListener('drop', _dropItemOnEmptyGroup, false);
  };
  ...
  var attachEmptyGroupEvents = function attachEmptyGroupEvents(group) {
    ...
    removeBtn.addEventListener('click', removeGroup, false);
    group.addEventListener('drop', _dropItemOnEmptyGroup, false);
    group.addEventListener('dragover', function (event) {
      return event.preventDefault();
    }, false);
  };
  ...
  var addGroup = function addGroup(group) {
    ...
    if (groupElements.length) {
      ...
      insertedGroup.removeEventListener('drop', _dropItemOnEmptyGroup, false);
    }
