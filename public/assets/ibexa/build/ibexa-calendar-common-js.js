...
(function (global, doc, ibexa, bootstrap, Translator) {
  ...
  var handleConfirm = function handleConfirm() {
    var errorMessage = Translator.trans(/*@Desc("Cannot cancel selected hide(s)")*/'unschedule.future_hide.error.message', {}, 'ibexa_calendar_events');
    var body = {
      UnscheduleAction: {
...
(function (global, doc, ibexa, bootstrap, Translator) {
  ...
  var handleConfirm = function handleConfirm() {
    var errorMessage = Translator.trans(/*@Desc("Cannot cancel selected publication(s)")*/'unschedule.error.message', {}, 'ibexa_calendar_events');
    var body = {
      UnscheduleAction: {
        events: Object.keys(selectedEvents)
      }
...
(function (global, doc, ibexa, bootstrap, flatpickr, Translator) {
  ...
  var handleConfirm = function handleConfirm() {
    var errorMessage = Translator.trans(/*@Desc("Cannot reschedule")*/'reschedule.error.message', {}, 'ibexa_calendar_events');
    var body = {
      RescheduleAction: {
        events: Object.keys(selectedEvents),
