(self["webpackChunk"] = self["webpackChunk"] || []).push([["ibexa-shipment-view-js"],{

/***/ "./vendor/ibexa/shipping/src/bundle/Resources/public/js/state.transition.js"
/*!**********************************************************************************!*\
  !*** ./vendor/ibexa/shipping/src/bundle/Resources/public/js/state.transition.js ***!
  \**********************************************************************************/
() {
...
(function (global, doc, Translator) {
  ...
  transitionModal.addEventListener('show.bs.modal', function (_ref) {
    ...
    transitionModalBody.innerHTML = Translator.trans(/*@Desc("Are you sure you want to change the shipment status to %status%?")*/'ibexa.state.transition.modal.transition.body', {
      status: status
    }, 'ibexa_shipment');
...
/******/ var __webpack_exports__ = (__webpack_exec__("./vendor/ibexa/shipping/src/bundle/Resources/public/js/state.transition.js"));
/******/ }
]);