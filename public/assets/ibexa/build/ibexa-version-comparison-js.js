(self["webpackChunk"] = self["webpackChunk"] || []).push([["ibexa-version-comparison-js"],{

/***/ "./public/bundles/ibexaadminui/js/scripts/admin.location.load.map.js"
/*!***************************************************************************!*\
  !*** ./public/bundles/ibexaadminui/js/scripts/admin.location.load.map.js ***!
  \***************************************************************************/
() {
...
/***/ "./vendor/ibexa/version-comparison/src/bundle/Resources/public/js/scripts/admin.version.comparison.js"
/*!************************************************************************************************************!*\
  !*** ./vendor/ibexa/version-comparison/src/bundle/Resources/public/js/scripts/admin.version.comparison.js ***!
  \************************************************************************************************************/
() {
...
(function (global, doc, Routing) {
  var versionA = doc.querySelector('#version_comparison_version_a_version_info');
  var versionB = doc.querySelector('#version_comparison_version_b_version_info');
  if (!versionA || !versionB) {
    return;
  }
  var comparisonButton = doc.querySelector('#version_comparison_compare');
  var sideBySideButton = doc.querySelector('#version_comparison_side_by_side');
  var languageSelect = doc.querySelector('#version_comparison_language');
  var loadVersion = function loadVersion() {
  ...
  var getRouteData = function getRouteData() {
    var contentInfoId = doc.querySelector('.ibexa-version-compare').dataset.contentId;
    var _versionA$options$ver = versionA.options[versionA.selectedIndex].dataset,
      versionNoA = _versionA$options$ver.versionNo,
      versionALanguageCode = _versionA$options$ver.versionLanguageCode;
    var _versionB$options$ver = versionB.options[versionB.selectedIndex].dataset,
      versionNoB = _versionB$options$ver.versionNo,
      versionBLanguageCode = _versionB$options$ver.versionLanguageCode;
    var language = languageSelect.options[languageSelect.selectedIndex].value;
    var routeData = {
      contentInfoId: contentInfoId,
      versionNoA: versionNoA,
      versionALanguageCode: versionALanguageCode
    };
    if (language) {
  ...
  var redirectToSideBySide = function redirectToSideBySide() {
    var routeData = getRouteData();
    global.location.href = Routing.generate('ibexa.version.compare.split', routeData);
  };
  var redirectToComparison = function redirectToComparison() {
    var routeData = getRouteData();
...
/******/ var __webpack_exports__ = (__webpack_exec__("./vendor/ibexa/version-comparison/src/bundle/Resources/public/js/scripts/admin.version.comparison.js"), __webpack_exec__("./vendor/ibexa/admin-ui-assets/src/bundle/Resources/public/vendors/leaflet/dist/leaflet.js"), __webpack_exec__("./public/bundles/ibexaadminui/js/scripts/admin.location.load.map.js"));
/******/ }
]);