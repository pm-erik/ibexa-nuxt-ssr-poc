...
(function (global, doc, ibexa, React, ReactDOM, Translator) {
  ...
  var findLocationsByIdList = function findLocationsByIdList(pathArraysWithoutRoot, callback) {
    ...
    var errorMessage = Translator.trans(/*@Desc("Could not fetch content names")*/'limitation.pick.error', {}, 'ibexa_universal_discovery_widget');
  ...
  var openUDW = function openUDW(event) {
    ...
    var title = Translator.trans(/*@Desc("Choose Locations")*/'subtree_limitation.title', {}, 'ibexa_universal_discovery_widget');
