...
var CategoryPathSelect = /*#__PURE__*/function () {
  ...
  return _createClass(CategoryPathSelect, [{
    key: "init",
    value: function init() {
      var _this = this;
...
(function (doc, ibexa, bootstrap) {
  ...
  var removeStrategyModel = function removeStrategyModel(event) {
    ...
    var _toggleStrategyPlaceholderAfterRemove = function toggleStrategyPlaceholderAfterRemove() {
      container.classList.remove('ibexa-perso-strategy-model--removed');
      container.removeEventListener('animationend', _toggleStrategyPlaceholderAfterRemove, false);
    ...
    container.addEventListener('animationend', _toggleStrategyPlaceholderAfterRemove, false);
  };
